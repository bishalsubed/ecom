...
export default function Home() {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium text-pink-500 title-font mb-2">Decorate Your House And Comfort Your Life With Us</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">-Look Around Seems A little Frustrating? Then Surf And Buy Stylish Products To Make Your House Look Amazing And Attracting.</p>
    </div>
