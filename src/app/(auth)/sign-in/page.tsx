...
const signin = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen p-2 bg-gray-100">
      <div className="w-full max-w-md p-6 space-y-8 rounded-lg shadow-lg border">
        <div className="text-center">
          <h1 className="text-3xl font-extrabold tracking-tight lg:text-4xl mb-5">
            Welcome To GharSadhan
          </h1>
          <p className="mb-4 text-gray-600">Sign In To Provide You Goods and Services</p>
        </div>
        <Form {...form}>
